...
const Module13: React.FC<Props> = ({ page }) => {
  ...
  const quizQuestions: QuizQuestion[] = [
    { id: 1, question: 'Q1: Which useEffect dependency array configuration triggers the effect only once on mount?', options: ["A. Empty dependency array []", "B. No dependency array at all", "C. Dependency array listing all state variables", "D. Dependency array containing true/false values"], correctAnswer: "A. Empty dependency array []" },
    ...
    { id: 3, question: 'Q3: How does useMemo differ from useCallback?', options: ["A. useMemo caches functions, useCallback caches variables", "B. useMemo runs only on mount, useCallback runs on every click", "C. useMemo memoizes computed values, useCallback memoizes function instances", "D. There is no difference"], correctAnswer: "C. useMemo memoizes computed values, useCallback memoizes function instances" },
    { id: 4, question: 'Q4: What naming convention should all React hooks (including custom hooks) follow?', options: ["A. start with capital letters", "B. end with \"Hook\"", "C. camelCase only", "D. prefix with the word \"use\" (e.g. useFetch)"], correctAnswer: "D. prefix with the word \"use\" (e.g. useFetch)" },
    { id: 5, question: 'Q5: How do you return a cleanup function from inside a useEffect hook?', options: ["A. Return a function inside the effect body", "B. call a cleanup() function at the end", "C. add a finally block", "D. Pass a cleanup option to useEffect"], correctAnswer: "A. Return a function inside the effect body" },
  ];
