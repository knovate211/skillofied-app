    ...
    quiz: [
      {
        ...
        options: [
          ...
          'The bandwidth is being shared with other users',
          'SSH cannot use more than 10 Mbps',
      ...
      },
      {
        ...
        options: [
          ...
          'The physical topology becomes a mesh',
          'Broadcast traffic stops entirely',
        ],
        correctAnswer:
          'The logical topology — a switch forwards each frame only to the destination port, so each port becomes its own collision domain',
      },
      {
        ...
        options: [
          ...
          'Circuit switching cannot carry digital data',
          'Packet switching eliminates the need for routing decisions',
        ],
      ...
      },
      {
        ...
        options: [
          ...
          'The link can only transfer 12.5 MB in total',
          'Packets larger than 12.5 MB will be fragmented',
          'The router needs 12.5 MB of buffer memory',
        ],
        correctAnswer:
          'The TCP window must hold at least 12.5 MB of unacknowledged data or the sender stalls and cannot fill the link',
      },
      {
        ...
        options: [
          ...
          'Popular files are cached by ISPs automatically',
      ...
      prompts: [
        {
          ...
          options: [
            ...
            'The file is too small to reach full speed',
          ],
        ...
        },
        {
          ...
          options: [
            ...
            'It does not depend on latency, only on bandwidth',
          ],
